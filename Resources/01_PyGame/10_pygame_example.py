...
if __name__=='__main__':
    ...
    print(os.path.join(shipsPath,"Bismark.png"))

    ship1 = pygame.image.load(os.path.join(shipsPath,"Bismark.png")).convert()
    ship2 = pygame.image.load(os.path.join(shipsPath,"Iowa.png")).convert()
    ...
    screen.blit(ship1, ( 450,450)) # paint to screen
    screen.blit(ship2, ( 50,50)) # paint to screen
